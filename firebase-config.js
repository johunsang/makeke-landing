...
const DEFAULT_DOWNLOAD_URLS = {
  macOS: `${RELEASES_BASE}/v1.1.73/Makeke-mac-v1.1.73.zip`,
  "macOS-intel": `${RELEASES_BASE}/v1.1.73/Makeke-mac-intel-v1.1.73.zip`,
  windows: `${RELEASES_BASE}/v1.1.73/Makeke-win-v1.1.73.exe`
};

// 현재 버전 기본값 (Firestore config 컬렉션에 저장된 값이 우선)
const DEFAULT_VERSION = "1.1.73";
